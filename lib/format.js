...
export const pct = (v) => `${(Number(v ?? 0) * 100).toFixed(1).replace('.', ',')}%`

// Indice adimensional, como o HHI. Em portugues o ponto e separador de milhar,
// entao um toFixed(3) cru faz 1,000 parecer mil.
export const indice = (v, casas = 3) =>
